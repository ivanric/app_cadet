...
//	public Path linkArchivoCatalogo(String nombreArchivo ) throws IOException;;
	...
	public String guargarArchivoDrive(String nameFolderLogoCatalogo, MultipartFile logo, String nombreLocal) throws IOException, GeneralSecurityException;
...
//	public void eliminarArchivoCatalogo(String nombreArchivo) throws IOException;;
	...
	public void eliminarArchivoDrive(String nameFolderLogoCatalogo, String nombrelogoDriveId) throws IOException, GeneralSecurityException;
}
